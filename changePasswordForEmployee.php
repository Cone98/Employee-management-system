        ...
        <div class="well" style="position:relative;top:20vh;">
            <form class="form-horizontal form-custom-login" action="" method="POST">
                <div class="form-heading" style="background: orange;">
                    <h2 class="text-center">Promenite lozinku</h2>
                </div>
                ...
                <div class="form-group">
                    <input type="password" class="form-control" placeholder="Ponovo unesite lozinku" name="re_password" required/>
                </div>
                <button type="submit" name="change_password_btn" class="btn btn-default pull-right">Promeni lozinku
                </button>
            </form>
        </div>
    </div>
