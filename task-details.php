        ...
        <div class="well well-custom">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="well">
                        <h3 class="text-center bg-primary" style="padding: 7px;">Detalji zadatka </h3><br>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-single-product">
                                        ...
                                        <tr>
                                            <td>Opis</td>
                                            <td><?php
                                                echo $row['t_description']; ?></td>
                                        </tr>
                                        <tr>
                                        </tr>
                                        <tr>
                                            <td>Rok za izvrsenje</td>
                                            <td><?php
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <a title="Update Task" href="task-info.php"><span
                                                    class="btn btn-success-custom btn-xs">Idi nazad</span></a>
                                    </div>
                                </div>
                                </form>
                            </div>
